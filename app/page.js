...
export default function Page() {
  ...
  const alacarte = [
    ...
    { name: "Living / Common Area", price: "$45" },
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800">
      ...
      <section id="home" className="relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 py-20 md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                ...
                className="rounded-2xl bg-emerald-600 px-5 py-3 text-white font-semibold shadow hover:bg-emerald-700"
              >
                Book a Cleaning
              </a>
      ...
      <section id="alacarte" className="py-16">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {alacarte.map((i) => (
              <div key={i.name} className="rounded-2xl border border-slate-200 p-5 bg-white flex items-center justify-between">
      ...
      <section id="contact" className="bg-emerald-600 text-white py-16">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-4 inline-block rounded-2xl bg-white px-5 py-3 text-emerald-700 font-semibold shadow hover:bg-emerald-50"
          >
            Book Now
          </a>
        </div>
