        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-6 rounded-2xl border border-gray-100 p-6">
            ...
            <p className="text-xs text-gray-500 mt-3">
              ...
              sizes, we&apos;ll round in your favor or give a custom quote so
              pricing still feels fair.
            </p>

            <p className="text-xs text-gray-500 mt-2">
              <b>Maintenance Cleans (Returning Clients):</b> After your first
              visit, recurring cleanings are discounted and based on frequency
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-4 rounded-2xl border border-gray-100 p-6">
            <p className="text-gray-600">
              Commercial spaces are priced by square footage and cleaning
              frequency. Get a fast quote and schedule directly online from our
              booking page.
            </p>
            <div className="mt-4">
              <a
