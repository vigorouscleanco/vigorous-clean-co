    ...
    <div>
      ...
      <section className="container-app py-12">
        ...
        <div className="mt-4 rounded-xl bg-primary/10 text-primary px-4 py-3 text-sm">
          ...
          Your first visit is always an <b>All-Inclusive Deep Clean</b>. Once we&apos;ve
          seen your home, we&apos;ll confirm your{" "}
      ...
      <section className="container-app pb-4">
        ...
        <p className="text-gray-600 mt-1 text-sm sm:text-base">
          Flat daily rates — never hourly. One cleaner for up to ~8 hours. Most homes are
          cleaned in a single day.
        </p>
          ...
          <div className="rounded-2xl border border-gray-100 p-6">
            ...
            <div className="mt-4 grid sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-x-12 gap-y-3 text-sm">
              <div className="flex justify-between gap-6">
                ...
                <span className="font-medium">$130 / day</span>
              </div>
              <div className="flex justify-between gap-6">
            ...
            <p className="text-xs text-gray-500 mt-3">
              ...
              oven, baseboards, interior windows, and detailed bathroom/kitchen work. If your
              home is right on the edge between sizes, we&apos;ll round in your favor or give a
            ...
            <p className="text-xs text-gray-500 mt-2">
              ...
              frequency (weekly, bi-weekly, or monthly). We&apos;ll confirm your exact rate
      ...
      <section className="container-app pb-14">
        <div className="rounded-2xl bg-gray-50 border border-gray-100 p-5 text-sm text-gray-600">
          <ul className="list-disc pl-5 space-y-2">
            <li>
              Pricing is per day, per cleaner. We stay until the job is complete for the day.
            </li>
            <li>
              Larger homes/offices may require multiple days or additional cleaners (quoted
              ahead of time).
            </li>
            <li>
            ...
            <li>
              New clients receive <b>10% off</b> their first cleaning — discount is applied
