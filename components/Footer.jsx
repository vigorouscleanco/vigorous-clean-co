...
export default function Footer() {
  return (
    <footer className="mt-16 border-t border-gray-100">
      <div className="container-app py-10 grid md:grid-cols-3 gap-10">
        <div>
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-4 leading-relaxed">
            Disclaimer: We are not liable for pre-existing damage, normal wear and tear, or items not disclosed
            as fragile. Loss/theft of unattended valuables is not covered. Specialty/hazardous tasks are excluded
            unless agreed in writing.
          </p>
        </div>
      </div>

      {/* pad extra at bottom so widgets don't overlap */}
      <div className="pb-10 md:pb-14 border-t border-gray-100">
