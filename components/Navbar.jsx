      ...
      {open && (
        <div className="md:hidden border-t border-gray-100 bg-white">
          <div className="container-app py-4 flex flex-col gap-3">
            ...
            <a href="tel:+14242605986" className="text-sm font-medium">(424) 260-5986</a>
            <a href="https://book.squareup.com/appointments/0d8cas6ix7qhc2/location/L9K9470312P89/services" target="_blank" rel="noopener" className="rounded-xl bg-primary px-4 py-2 text-white text-sm font-medium text-center" onClick={() => setOpen(false)}>
              Book Now
            </a>
          </div>
        </div>
